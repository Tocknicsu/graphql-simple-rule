...
var RuleHelper = exports.RuleHelper = function RuleHelper(rules, fields) {
...
exports.default = function (config) {
  ...
  config = (0, _defaults2.default)(config, {
    ...
    cache: {
      enable: true,
      key: function key(obj, args, context, info) {
        if (!context._graphqlSimpleRuleCacheKey) {
          context._graphqlSimpleRuleCacheKey = _uuid2.default.v4();
        }
  ...
  return function (func) {
    ...
    return function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        var props, cacheKey, cache, propsKey, _propsKey, rule, info;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 53:
                _context2.next = 55;
                return funcWrapper(config.defaultRule.readable, [props]);
